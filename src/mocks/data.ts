...
export const courseDetails: Record<string, CourseDetail> = {
  course1: {
    ...
    chapters: [
      { id: "c1", title: "节日概览", type: "article", content: "中国传统节日以农时为本，凝聚亲情与伦理秩序，形成独特的时间仪式。" },
      { id: "c2", title: "春节", type: "article", content: "爆竹迎春，守岁拜年，年画对联与团圆饭体现祈福与家族团聚。" },
      { id: "c3", title: "清明", type: "article", content: "踏青与祭祖并行，缅怀先人，亲近自然，弘扬孝悌之德。" },
      { id: "c4", title: "端午", type: "article", content: "龙舟竞渡与艾草驱疫，纪念屈原，寄托忠诚与洁净的愿望。" },
      { id: "c5", title: "中秋", type: "article", content: "赏月食糕，以月之圆兆人之团圆，表达思亲与团聚。" },
    ],
    related: ["course2", "etiquette"],
  },
  course2: {
    id: "course2",
    title: "30天论语精选",
    ...
    chapters: [
      { id: "c1", title: "学而时习之", type: "article", content: "学习贵在常习，知行相资，方能融会贯通。" },
      { id: "c2", title: "三人行必有我师", type: "article", content: "善择人之长为我所师，以人之短为我所戒。" },
      { id: "c3", title: "君子和而不同", type: "article", content: "价值多元下的谦抑与尊重，求同存异以成共识。" },
      { id: "c4", title: "忠恕之道", type: "article", content: "推己及人，以己度人，形成稳定的伦理互信。" },
      { id: "c5", title: "礼之用和为贵", type: "article", content: "礼的核心是和，不在外在繁文，而在关系的调和。" },
    ],
    related: ["course3", "tea"],
  },
  course3: {
    ...
    chapters: [
      { id: "c1", title: "春晓·孟浩然", type: "article", content: "春眠不觉晓，处处闻啼鸟，捕捉春之勃发与宁静。" },
      { id: "c2", title: "静夜思·李白", type: "article", content: "举头望明月，低头思故乡，凝练乡愁意象。" },
      { id: "c3", title: "黄鹤楼送孟浩然之广陵·李白", type: "article", content: "长江天际流，以壮阔景象承载别绪。" },
      { id: "c4", title: "登鹳雀楼·王之涣", type: "article", content: "欲穷千里目，更上一层楼，示理想与视野的提升。" },
      { id: "c5", title: "望庐山瀑布·李白", type: "article", content: "飞流直下三千尺，奇崛与灵动兼容。" },
    ],
    related: ["course2", "etiquette"],
  },
  etiquette: {
    ...
    chapters: [
      { id: "c1", title: "礼的起源与精神", type: "article", content: "礼以分寸定关系，以敬意达和谐，内在追求是自律与尊重。" },
      { id: "c2", title: "见面之礼", type: "article", content: "拱手与鞠躬体现谦抑与尊对，称谓与次序传递关系定位。" },
      { id: "c3", title: "餐桌礼仪", type: "article", content: "入座、夹菜、敬茶等细节映射互相体谅与分享。" },
      { id: "c4", title: "服饰与仪容", type: "article", content: "整洁合宜、颜色与场合相配，体现礼的审美。" },
      { id: "c5", title: "节庆与仪式", type: "article", content: "婚丧祭祀等礼仪，维系群体记忆与伦理秩序。" },
    ],
    related: ["course1", "tea"],
  },
  tea: {
    ...
    chapters: [
      { id: "c1", title: "识茶与分类", type: "article", content: "六大茶类以工艺区分，风味由产地与制作决定。" },
      { id: "c2", title: "器具与水", type: "article", content: "壶盏之选与水温水质决定茶汤表现。" },
      { id: "c3", title: "泡茶步骤", type: "article", content: "温杯醒茶、定量注水、出汤分杯，循序渐进。" },
      { id: "c4", title: "品饮礼仪", type: "article", content: "奉茶致意，三口识味，专注而克制。" },
      { id: "c5", title: "常见误区", type: "article", content: "过量高温、长泡不出汤等影响口感与健康。" },
    ],
