...
// import QnAEncyclopedia from "@/components/QnAEncyclopedia"; // 暂时未使用的组件可以注释或保留
// import ThematicCourses from "@/components/ThematicCourses";   // 暂时未使用的组件可以注释或保留
import { 
  carouselItems, 
  featureModules, 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {featureModules.map((module) => (
              <FeatureCard
                ...
                icon={module.icon}
                color={module.color}
                link={module.link} // FeatureCard 本身已经支持 link
              />
            ))}
          </div>
        </section>
